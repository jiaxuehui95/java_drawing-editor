...
public class RoundedRectangle extends Figure {
	...
	public boolean equals(Object o)
	{
		if (super.equals(o))
		{
			RoundedRectangle r = (RoundedRectangle) o;
			RoundRectangle2D r1 = (RoundRectangle2D) shape;
			RoundRectangle2D r2 = (RoundRectangle2D) r.shape;

			return ((r1.getMinX() == r2.getMinX()) &&
			        (r1.getMinY() == r2.getMinY()) &&
			        (r1.getWidth() == r2.getWidth()) &&
			        (r1.getHeight() == r2.getHeight()) &&
			        (r1.getArcHeight() == r2.getArcHeight())&&
			        (r1.getArcWidth() == r2.getArcWidth()));
		}
	...
	/**
	 * Création d'un RoudedRectangle sans points (utilisé dans les classes filles

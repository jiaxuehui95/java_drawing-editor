...
*/
	...
	private class ToggleCreateEditAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			/*
			 * Parcourir tous les "buttons" pour s'assurer qu'ils sont
	...
	private class ShapeFilterAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			// TODO Compléter ...
			ShapeFilter2 sf = new ShapeFilter2(type);
			if (selected)
			{
	...
	private class FillColorFilterAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			boolean selected = button.getModel().isSelected();
			FillColorFilter<Paint> ff = new FillColorFilter<Paint>(drawingModel.getFillpaint());
			if(selected)
			{
			drawingModel.setFillColorFilter(ff);
			}
			else 
			{
				drawingModel.setFillColorFilter(ff);
	...
	private class EdgeColorFilterAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			// TODO Compléter ...
			EdgeColorFilter<Paint> ef = new EdgeColorFilter<Paint>(drawingModel.getEdgePaint());
			if(selected)
			{
			drawingModel.setEdgeColorFilter(ef);
			}
			else 
			{
				drawingModel.setEdgeColorFilter(ef);
	...
	private class StyleAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			drawingModel.applyStyleToSelected(drawingModel.getFillpaint(), 
												drawingModel.getEdgePaint(),
												drawingModel.getStroke());
		}
	}
